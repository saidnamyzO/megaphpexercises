...
class ArrayUtils
{
	...
	//Elegir elementos que empiezan por una letra concreta
	public function mostrarArrayLetra($letra){
		...
		if(count($nombres_elegidos)==0){
			echo 'No hay ningún nombre que empiece con '.$letra;
		}
