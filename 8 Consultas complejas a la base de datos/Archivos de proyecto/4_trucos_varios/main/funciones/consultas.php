...
function getUsuarios(){
	...
	$resultado .='<tr>
					...
					<td>'.$fila['nivel'].'</td>
					<td><a href="editar_usuarios.php?id='.$fila['id'].'" class="enlace_rojo"><img src="images/editar.png" width="18px"></a></td>
					<td><a href="funciones/borrar_usuarios.php?id='.$fila['id'].'" class="enlace_rojo" onclick="return confirmar()"><img src="images/borrar.gif"  width="20px"></a></td>
				  </tr>';	
	}
