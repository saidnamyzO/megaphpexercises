...
<script src="<?php get_theme_url(); ?>/bjqs.min.js"></script>
<script src="<?php get_theme_url(); ?>/script.js"></script>
<link rel="stylesheet" href="<?php get_theme_url(); ?>/slide.css" type="text/css"/>
...
<div id="slider">
	<ul class="bjqs">
    	...
    	<?
			$directory = get_site_url().'data/uploads/slide';
				$dirint = dir($directory);
					while (($archivo = $dirint->read()) !== false)
					{
						if(eregi("gif",$archivo) ||	eregi("jpg",$archivo) || eregi("png",$archivo)){
							echo '<li><img src="'.$directory.'/'.$archivo.'"/></li>';
						}
					}
